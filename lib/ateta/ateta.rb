    ...
    def generate_stim(forbiddenVectors = [])
      ...
      @insertionPoints.each do |insertPointName|
        ...
        downstreamOuputs.each do |targetedOutputName|
          # Appliquer Ateta_sat
          solver = AtetaAddOn::AtetaSat.new(@initCirc, @altCirc, insertPointName, targetedOutputName,
                                            @delayModel, forbiddenVectors, @memoizer, @payload_delay)
    ...
    def generate_glitch_stim(forbiddenVectors = [])
      ...
      @insertionPoints.each do |insertPointName|
        ...
        downstreamOuputs.each do |targetedOutputName|
          # Appliquer Ateta_sat
          solver = AtetaAddOn::AtetaSat.new(@initCirc, @altCirc, insertPointName, targetedOutputName,
                                            @delayModel, forbiddenVectors, @memoizer, @payloadDelay)
